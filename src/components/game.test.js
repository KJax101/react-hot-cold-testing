...
// running several tests on game
// every it statement is a test
describe('<Game />', () => {
  // smoke testing to see if game renders without crashing
  it('Renders without crashing', () => {
    // rendering game
    shallow(<Game />);
  });

// This test checks to see if the component does start a new game
  it('Can starts a new game', () => {
    const wrapper = shallow(<Game />);
    // Messing with the state to simulate an existing game
    wrapper.setState({
      guesses: [1, 2, 3, 4],
      feedback: 'Check It',
